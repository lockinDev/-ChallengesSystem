package com.devlockin.gamification.game.configuration;
...
public class AMQPConfiguration {
	...
	public MessageHandlerMethodFactory messageHandlerMethodFactory() {
		...
		jsonConverter.getObjectMapper().registerModules(new ParameterNamesModule(JsonCreator.Mode.PROPERTIES));
